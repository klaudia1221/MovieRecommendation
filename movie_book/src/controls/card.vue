...
.cards {
  ...
  .card {
    ...
    &:hover {
      ...
      transform: translateY(-5px); // top: -10px;
    }
    &:active {
    ...
    .image-top {
      ...
      .not-favorite {
        box-shadow: 0px 0px 2px $color-pink;
      ...
      <!-- where there is loading -->
        ...
        >
          <div class="image-top">
            ...
            <button
              class="btn-round not-favorite"
              v-if="islist"
              @click.stop="$emit('not_seen')"
            >
            ...
            <button
              class="btn-round  favorite"
              v-if="islist"
              @click.stop="$emit('fav_add')"
            >
